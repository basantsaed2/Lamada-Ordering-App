...
const LoginPage = () => {
       ...
       const { postData: postEmail, loadingPost: loadingEmail, response: responseEmail } = usePost({ url: 'https://lamadabcknd.food2go.online/customer/otp/create_code' });
       const { postData: postPhone, loadingPost: loadingPhone, response: responsePhone } = usePost({ url: 'https://lamadabcknd.food2go.online/api/user/auth/signup/phone_code' });
       const { postData: postLogin, loadingPost: loadingLogin, response: responseLogin } = usePost({ url: 'https://lamadabcknd.food2go.online/api/user/auth/login' });
       const { postData: postNewLogin, loadingPost: loadingNewLogin, response: responseNewLogin } = usePost({ url: 'https://lamadabcknd.food2go.online/customer/otp/change_password' });
